...
void ViatorParameters::Params::initSliderParams()
{
    ...
    _sliderParams.push_back({ViatorParameters::reductionID, ViatorParameters::reductionName, 0.0, 100.0, 0.0, skew::kSkew, 75.0, type::kInt});
    ...
    // for attachments
    _pluginSliderParams.push_back({ViatorParameters::reductionID, ViatorParameters::reductionName, 0.0, 100.0, 0.0, skew::kSkew, 75.0, type::kInt});
