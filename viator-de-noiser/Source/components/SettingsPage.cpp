...
SettingsPage::SettingsPage(ViatordenoiserAudioProcessor& p) : audioProcessor(p)
{
    // labels
    int index = 0;
    initThemeLabelProps();
...
void SettingsPage::initThemeMenuProps()
{
    ...
    {
        auto* parent = dynamic_cast<ViatordenoiserAudioProcessorEditor*>(getParentComponent());
